    ...
    <div className="flex flex-col gap-6 border-b border-slate-200 pb-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          <h2 className="text-xl font-bold text-slate-900">اخبار</h2>
          <p className="text-sm text-slate-500">
            اخبار را بر اساس علاقه و زمان خود فیلتر کنید و آخرین مطالب را ببینید.
          </p>
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <input
            ...
            placeholder="جستجوی سریع در بین اخبار"
            disabled={disabled}
            aria-disabled={disabled}
          />
          {hasActiveFilters && (
